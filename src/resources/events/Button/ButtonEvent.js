    ...
    async run(client, interaction) {
        ...
        if (interaction.customId === "whitelist") {
            ...
            const Modal = new ModalBuilder()
                ...
                .setTitle("Sua whitelist")

            const TextIdJogo = new TextInputBuilder()
                .setCustomId("id_jogo")
                .setLabel("Qual seu ID?")
                .setMaxLength(7)
                .setMinLength(1)
                .setPlaceholder("Insira seu ID in-game")
                .setStyle(TextInputStyle.Short)

            const TextNamePers = new TextInputBuilder()
                .setCustomId("name_pers")
                .setLabel("Qual o nome do seu personagem?")
                .setMaxLength(20)
                .setMinLength(1)
                .setPlaceholder("Insira o seu nome in-game")
                .setStyle(TextInputStyle.Short)

            const rowID = new ActionRowBuilder().addComponents(TextIdJogo)
            const rowName = new ActionRowBuilder().addComponents(TextNamePers)

            Modal.addComponents(rowID, rowName)
